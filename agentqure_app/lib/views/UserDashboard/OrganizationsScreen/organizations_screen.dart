...
//   Map<String, dynamic>? _selectedCallOrganization;
//   Map<String, dynamic>? _selectedWhatsAppOrganization;
...
//   }
//
//   Future<void> _showOrganizationSelectionDialog(String actionType) async {
//     if (diagnosticsServices.isEmpty) {
...
//       actionText = 'Call';
//     } else {
//       actionIcon = FontAwesomeIcons.whatsapp;
...
//                   child: Row(
//                     children: [
//                       Icon(actionIcon, color: Colors.white, size: 24.w),
//                       SizedBox(width: 12.w),
//                       Expanded(
//                         child: Text(
//                           'Select Organization to $actionText',
...
//                                   overflow: TextOverflow.ellipsis,
//                                 ),
//                                 if (org['contactNumber'] != null &&
//                                     org['contactNumber'].isNotEmpty)
//                                   Row(
//                                     children: [
//                                       Icon(
//                                         Icons.phone,
...
//                               if (actionType == 'Call') {
//                                 setState(() {
//                                   _selectedCallOrganization = org;
//                                 });
//                                 _makePhoneCall(org['contactNumber']);
//                               } else if (actionType == 'WhatsApp') {
//                                 setState(() {
//                                   _selectedWhatsAppOrganization = org;
//                                 });
//                                 _openWhatsApp(org['contactNumber']);
//                               }
//                             },
//                           ),
//                         ),
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text('No contact number available for this organization'),
//           backgroundColor: Colors.red,
//         ),
//       );
//       return;
...
//                           ],
//                         ),
//                         // if (onPressed == _uploadPrescription &&
//                         //     _prescriptionFiles.isNotEmpty)
//                         //   _buildPrescriptionCounter(),
//                       ],
//                     ),
//                   ),
//                 );
...
//                               size: 60.sp,
//                               // onPressed: () async {
//                               //   final uri = Uri.parse('tel:+919834221488');
//                               //   if (await canLaunchUrl(uri)) {
//                               //     await launchUrl(uri);
//                               //   } else {
//                               //     ScaffoldMessenger.of(context).showSnackBar(
...
//                               // },
//                               onPressed: () async {
//                                 await _showOrganizationSelectionDialog('Call');
//                               },
//                             ),
//                           ),
//                           Expanded(
...
//                               size: 60.sp,
//                               onPressed: () async {
//                                 await _showOrganizationSelectionDialog(
//                                   'WhatsApp',
//                                 );
//                               },
//                             ),
