  ...
  void _resendOtp() async {
    if (_canResend) {
      ...
      try {
        ...
        final response = await controller.sendOtp(widget.phoneNumber);

        // Update the verificationId with the new one from resend
        if (response['message'] == 'SUCCESS' && response['data'] != null) {
          setState(() {
            _currentVerificationId = response['data']['verificationId'];
          });
